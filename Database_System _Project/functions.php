<?php 
    ...
    class DB_con {
        ...
        public function registration($fname, $uname, $uemail, $password) {
            $reg = mysqli_query($this->dbcon, "INSERT INTO customer(fullname, username, useremail, password) VALUES('$fname', '$uname', '$uemail', '$password')");
            return $reg;
        }

        public function signin($uname, $password) {
            $signinquery = mysqli_query($this->dbcon, "SELECT cust_id, fullname FROM customer WHERE username = '$uname' AND password = '$password'");
            return $signinquery;
        }
    }
